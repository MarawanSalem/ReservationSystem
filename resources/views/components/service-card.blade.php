...
<div class="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
    <div class="relative">
        <img src="{{ $service->image ? Storage::url($service->image) : 'https://via.placeholder.com/400x300' }}"
             alt="{{ $service->name }}"
    ...
    <div class="p-4">
        ...
        <p class="mt-1 text-sm text-gray-600">{{ $service->service_provider }} • {{ $service->location }}</p>
